...
assert 1 "main(){return 4 <= 4;}"
assert 38 "main(){long abc; abc=15;long b; b=23; return abc+b;}"
assert 5 "main(){return 5; 4*5;}"
assert 3 "main(){long a; a = 0;while(a < 3) a = a + 1; return a;}"
assert 5 "main(){long a; a = 1; if(a == 1) return 5; return 4;}"
assert 3 "main(){long a; a=0; if(4 < 5) a = 2; else a = 3; return 3;}"
assert 6 "main(){long a;a = 3; if(0 < 6) {a = 1; a = a + 5;} return a;}"
assert 4 "main(){long a; long b;a = 0; b = 0; for(a = 1; a < 5; a = a + 1){b = b + 1;} return b;}"
...
assert 6 "main(){ long a; long b;a = 5; b = &a; *b = 3; return a + *b; }"
assert 15 "foo(long a, long b){return a + b;}main(){return foo(3 , 12);}"
echo OK